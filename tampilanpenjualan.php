...
<br>
  ...
  <div class="main"> 
    ...
    <button type="text"> <a href="inputpenjualan1.php">Tambah Penjualan</button></a>
...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names.." title="Type in a name">
    ...
    <table id="myTable" border="solid">
        ...
        <tbody>
            <tr>
            <td center><?php echo $tampil['TanggalPenjualan'];?></td>
            <td><?php echo $tampil['TotalHarga'];?></td>
            <td><?php echo $tampil['NamaPelanggan'];?></td>
            <td><button type="submit" name="edit"><a style="color: black;text-decoration:none"style="color: black;text-decoration:none" href="editpenjualan.php?PenjualanID=<?php echo $tampil['PenjualanID'];?>">EDIT</a></button></td>
            <td><button type="text"><a style="color: black;text-decoration:none" href="hapuspenjualan.php?PenjualanID=<?php echo $tampil['PenjualanID'];?>">Hapus</a></button></td>
            </tr>
            <?php
        }
            ?>
