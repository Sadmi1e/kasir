...
<br>
  ...
  <div class="main"> 
    ...
    <button type="text"> <a href="inputpelanggan.html">Tambah Pelanggan</button></a>
<br><br><br>
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names.." title="Type in a name">
    <table id="myTable" border="solid">
        ...
        <tbody>
            <tr>
            <td center><?php echo $tampil['NamaPelanggan'];?></td>
            <td><?php echo $tampil['Alamat'];?></td>
            <td><?php echo $tampil['NomorTelepon'];?></td>
            <td><button type="text"><a style="color: black;text-decoration:none"style="color: black;text-decoration:none" href="editpelanggan.php?PelangganID=<?php echo $tampil['PelangganID'];?>">EDIT</a></button></td>
