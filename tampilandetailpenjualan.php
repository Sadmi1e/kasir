...
<br>
  ...
  <div class="main"> 
    <h2 style="text-align: center;">Data Detail Penjualan</h2>
    <button type="text"> <a href="inputdetailpenjualan.html">Tambah Detail Penjualan</button></a>
<br><br><br>
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names.." title="Type in a name">
    <table id="myTable" border="solid">
        ...
        <tbody>
            <tr>
            <td center><?php echo $tampil['PenjualanID'];?></td>
            <td><?php echo $tampil['ProdukID'];?></td>
            <td><?php echo $tampil['JumlahProduk'];?></td>
            <td><?php echo $tampil['Subtotal'];?></td>
            <td><button type="text"><a style="color: black;text-decoration:none"style="color: black;text-decoration:none" href="editdetailpenjualan.php?DetailID=<?php echo $tampil['DetailID'];?>">EDIT</a></button></td>
            <td><button type="text"><a style="color: black;text-decoration:none" href="hapusdetailpenjualan.php?DetailID=<?php echo $tampil['DetailID'];?>">Hapus</a></button></td>
            </tr>
            <?php
        }
            ?>
